...
const Users = [
    { Name: 'Steve', Password: '1234', Email: 'steves@newpaltz.edu', userId: 1},
    { Name: 'Mathew', Password: '1235', Email: 'mathewh@newpaltz.edu', userId: 2 },
    { Name: 'James', Password: '1236', Email: 'jamesa@newpaltz.edu', userId: 3 },
    { Name: 'William', Password: '1237', Email: 'williamh@newpaltz.edu', userId: 4 },    
];
...
module.exports = {
    async Login(email, password) {
        ...
        if(!user) throw Error('Sorry! This username is not registered');
        if(user.Password != password) throw Error('Oops! Wrong password..please try again');
            return user;
        }
   },
    Get(userId) {
